...
dSet = [16, 64, 256, 1024]
dPara = np.array(dSet)+1
NSet = [128, 128, 128, 128]
...
labelTrue = ['pSVN d=16', 'pSVN d=64', 'pSVN d=256', 'pSVN d=1024']
labelFalse = ['SVN d=16', 'SVN d=64', 'SVN d=256', 'SVN d=1024']
fig1 = plt.figure(1)
fig2 = plt.figure(2)
for case in [0, 1, 2, 3]:
    ...
    for i in range(Ntrial):
        filename = "dimension-" + str(d) + "/data/data_nSamples_" + str(N) + "_isProjection_" + str(True) + "_SVN_" + str(i+1) + ".p"
        ...
        filename = "dimension-" + str(d) + "/data/data_nSamples_" + str(N) + "_isProjection_" + str(False) + "_SVN_" + str(i+1) + ".p"
        ...
        filename = "dimension-" + str(d) + "/data/data_nSamples_" + str(N) + "_isProjection_" + str(False) + "_SVGD_" + str(i+1) + ".p"
...
plt.figure(1)
plt.legend(fontsize=16)
plt.xlabel("Log2(Dimension)", fontsize=16)
plt.ylabel("Log10(RMSE of mean)", fontsize=16)

plt.tick_params(axis='both', which='major', labelsize=16)
plt.tick_params(axis='both', which='minor', labelsize=16)

filename = "figure/error_mean_dimension"+"SVN.pdf"
fig1.savefig(filename, format='pdf', bbox_inches='tight')
filename = "figure/error_mean_dimension"+"SVN.eps"
fig1.savefig(filename, format='eps', bbox_inches='tight')
...
filename = "figure/error_variance_dimension"+"SVN.pdf"
fig2.savefig(filename, format='pdf', bbox_inches='tight')
filename = "figure/error_variance_dimension"+"SVN.eps"
fig2.savefig(filename, format='eps', bbox_inches='tight')
